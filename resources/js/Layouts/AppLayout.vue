<template>
    <div class="bg-gray-50 dark:bg-gray-900">
        <nav class="z-20 bg-white shadow-md dark:bg-gray-800">
            ...
            >
                ...
                <div class="pt-2 pb-3 space-y-1">
                    <jet-responsive-nav-link
                        ...
                        >Organizations</jet-responsive-nav-link
                    >
                </div>
                ...
                <div class="pt-2 pb-3 space-y-1">
                    <jet-responsive-nav-link
                        ...
                        >Contacts</jet-responsive-nav-link
                    >
                </div>
                ...
                <div class="pt-2 pb-3 space-y-1">
                    <jet-responsive-nav-link
                        ...
                        >Reports</jet-responsive-nav-link
                    >
                </div>
            </aside>

            <div
                class="flex flex-col flex-1 w-full h-full pb-16 overflow-y-auto"
            >
